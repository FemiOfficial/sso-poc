...
func NewTokenEncryption() (*TokenEncryption, error) {
	// Load from env or key management service
	keyString := os.Getenv("ENCRYPTION_KEY") // 32 bytes for AES-256
...
func (t *TokenEncryption) Decrypt(ciphertext string) (string, error) {
